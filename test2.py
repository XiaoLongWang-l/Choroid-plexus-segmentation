...
import os
from medical.trainer import Validator


parser = argparse.ArgumentParser(description='Swin UNETR segmentation pipeline for BRATS Challenge')
parser.add_argument('--model_name', default="UNet", help='the model will be trained')
parser.add_argument('--checkpoint', default="./logs/CT_0919/model.pt",
                    help='start training from saved checkpoint')

parser.add_argument('--logdir', default='CT_0919_2', type=str, help='directory to save the tensorboard logs1_32_64')
...
parser.add_argument('--roi_z', default=16, type=int, help='roi size in z direction')
