...
from models.UXNet_3D.tools.logger import Logger as Log
from models.UXNet_3D.tools.module_helper import ModuleHelper
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        model = UXNET(in_chans=1,out_chans=1,depths=[2, 2, 2, 2],feat_size=[48, 96, 192, 384],drop_path_rate=0,layer_scale_init_value=1e-6,spatial_dims=3,)
        model.cuda()
        print(model)
        y = model(x)
        print(y.shape)