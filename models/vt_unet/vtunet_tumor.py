...
from models.vt_unet.neural_network import SegmentationNetwork
...
class VTUNet(SegmentationNetwork):
    def __init__(self, pretrain_ckpt="./pretrained_ckpt/swin_tiny_patch4_window7_224_22k.pth", num_classes=1, zero_head=False, embed_dim=48, win_size=7):
